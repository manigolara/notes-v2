...
-- CHECK       Check all values meet specific criterias
/* ---------------------------------------------------
...
ALTER TABLE unique_brands
ADD CONSTRAINT my_unique_brand UNIQUE(brand_name, product_name);
INSERT INTO unique_brands (brand_name, product_name)
VALUES ('ACER', 'keyboard');
INSERT INTO unique_brands (brand_name, product_name)
VALUES ('ACER', 'mouse');
INSERT INTO unique_brands (brand_name, product_name)
VALUES ('ASUS', 'keyboard');
/* ---------------------------------------------------
...
ADD CONSTRAINT t_grades_course_id_session_id_pkey PRIMARY KEY (course_id, student_id);
/* ---------------------------------------------------
...
ALTER TABLE prices
ADD CONSTRAINT price_check CHECK (
        price > 0
        AND discount >= 0
        AND price > discount
    );
