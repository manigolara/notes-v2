...
- **Factory Method**: 
    ...
    - This pattern allows a class to delegate the responsibility of instantiating its objects to subclasses, thereby promoting loose coupling.
    ```java
    ...
    classDiagram
        ...
        Product <|.. ProductA
        Product <|.. ProductB
        ConcreteCreator --> ProductA : creates
        ConcreteCreator --> ProductB : creates
        Client --> ConcreteCreator : uses

        %% Illustrating client interaction with specific products
